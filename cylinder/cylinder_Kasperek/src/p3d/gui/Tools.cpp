...
static long int _lastStart;
static long int _lastElapsed;

static QString _figureName="";
static int _figureStep=-1;
...
void p3d::figureName(const string &filename) {
  _figureName=QString::fromStdString(filename);
}
