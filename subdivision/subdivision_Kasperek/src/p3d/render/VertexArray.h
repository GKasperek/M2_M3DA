...
class VertexArray
{
  ...
  std::map<GLuint,GLuint> _bufferIndex; // to know which buffer is bind to the given shader index
...
public:
  ...
  GLuint _nbComponent;  // corresponds to size of glVertexAttribPointer; must be 1,2,3 or 4
