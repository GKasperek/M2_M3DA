...
static Vector2 _currentTextPos,_initTextPos;
...
void draw(const std::string &s,double x,double y,double z,const float *modelview,const float *projection,const float *color) {
