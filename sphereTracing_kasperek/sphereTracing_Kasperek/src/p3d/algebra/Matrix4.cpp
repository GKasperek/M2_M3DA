...
void Matrix4::setFrame(const Vector3 &o,const Vector3 &i,const Vector3 &j,const Vector3 &k) {
  _m[0]=i.x();
  _m[1]=i.y();
  _m[2]=i.z();
  _m[3]=0.0;
...
Matrix4 Matrix4::frameInterpolate(const Matrix4 &m1,const Matrix4 &m2,double lambda) {
  Vector3 p1=m1.column(3).project();
  Vector3 p2=m2.column(3).project();
  Quaternion q1(m1);
  Quaternion q2(m2);
