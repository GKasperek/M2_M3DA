...
public:
    ...
    /// set Matrix with vector basis (o,i,j,k) (if vectors of frame 1=(o,i,j,k) are expressed in frame 0 then this=M1->0; the last row is (0,0,0,1))
    ...
    static Matrix4 frameInterpolate(const Matrix4 &m1, const Matrix4 &m2, double lambda);
};
